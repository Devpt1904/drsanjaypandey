  ...
  return (
    <footer className="border-t border-gray-100 bg-white py-16">
      <div className="mx-auto flex max-w-[1200px] flex-col items-center gap-8 px-8">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-[11px] font-semibold uppercase tracking-widest text-slate-400">
          <Link href="#" className="hover:text-navy transition-colors">Privacy Policy</Link>
          <Link href="#" className="hover:text-navy transition-colors">HIPAA Compliance</Link>
          <Link href="#" className="hover:text-navy transition-colors">Terms of Service</Link>
          <Link href="#" className="hover:text-navy transition-colors">Patient Portal</Link>
        </div>
